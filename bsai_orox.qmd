...
# this looks like a flaw in the area table. area_id 793 and 794 are used for
# both type == `STRATUM` and type == `SUBAREA BY DEPTH` which means you can't
# just join by survey_definition_id and area_id...
